...
import { CreateUserInput, LoginUserInput } from '../validations/user.validation';
import { createUser, findUser, findUserById, signTokens } from '../services/user.service';
...
export const registerUserHandler = async (req: Request<{}, {}, CreateUserInput>, res: Response, next: NextFunction) => {
    try {
        const { fullName, password, email, phone, type } = req.body;
...
export const loginUserHandler = async (
    ...
    try {
        ...
        const user = await findUser({ email, type });
