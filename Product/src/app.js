...
dataSource_1.AppDataSource.initialize()
    ...
    var productRepository = dataSource_1.AppDataSource.getRepository(product_1.Product);
    amqp.connect("amqps://hkymaegl:tcyz0U5zQgsSC6K7SifQCqOWx4IhAdg3@chimpanzee.rmq.cloudamqp.com/hkymaegl", function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume(QUEUE, function (message) { return __awaiter(void 0, void 0, void 0, function () {
                var orderReq, productIds, products;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            orderReq = JSON.parse(message.content.toString());
                            productIds = orderReq.products.map(function (product) { return parseInt(product.id); });
                            return [4 /*yield*/, productRepository.find({
                                    where: { "id": (0, typeorm_1.In)(productIds) }
                                })];
                        case 1:
                            products = _a.sent();
                            products.forEach(function (prod) { return prod.purchaseCount++; });
            ...
            app.get("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.findOneBy({ "id": parseInt(req.params.id) })];
                        case 1:
                            product = _a.sent();
                            res.send(product);
                            return [2 /*return*/];
            ...
            app.delete("/api/products/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productRepository.delete({ "id": parseInt(req.params.id) })];
                        case 1:
                            result = _a.sent();
                            res.send(result);
                            return [2 /*return*/];
            ...
            app.listen(PORT, function () {
                console.log("Product Service started at port ".concat(PORT, "...."));
            });
